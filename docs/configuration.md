...
Secrets and authentication configuration do **not** belong to this module; they belong to Better Auth — including where Better Auth persists users and sessions (see [authentication.md#persistence](./authentication.md#persistence)).
